  ...
  return (
    ...
    <div className="flex justify-center md:items-center h-full w-full bg-bg bg-no-repeat bg-white-1 bg-cover bg-center bg-local pt-10" >
      <div className="bg-white-1/85 max-w-[850px] h-max min-w-[310px] min-h-[350px] p-4 md:p-10">
        ...
        <Link href="./subjects" title="Explore available subjects." className="outline-offset-2 hover:outline-offset-4 outline-2 outline-dashed outline-orange-1 block w-max text-base font-medium text-white-1 bg-orange-1 rounded-full mt-10 px-6 py-1" >
          EXPLORE
        </Link>
      </div>
    </div>
    ...
    <div className="flex justify-between items-center flex-wrap md:flex-nowrap bg-grey/10 w-full divide-y-4 md:divide-y-0 md:divide-x-4 divide-orange-1 py-14" >
      <div className="w-11/12 md:w-1/2 min-w-[310px] h-[420px] md:h-[480px] p-4 md:p-10">
        ...
        <div className="w-6/11 mt-20">
          <Link className="mr-10 py-1 md:py-2 px-6 md:px-8 text-base hover:opacity-70 font-normal text-white-1 bg-black-1 border-2 border-black-1 rounded-full" href="./signup" title="Signup to help post educative content.">
            Join us
          </Link>
          <Link className="py-1 md:py-2 px-6 md:px-8 text-base hover:opacity-70 font-normal text-black-1 border-2 border-black-1 rounded-full" href="./login" title="Login to help post educative content.">
            Login
          </Link>
        </div>
      </div>
